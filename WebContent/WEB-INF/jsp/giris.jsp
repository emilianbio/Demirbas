...
<body>
	...
	<form action="./kullanicionay" method="post" class="form-inline"
		role="form">
		...
		<table bgcolor="#7892c2" align=center border=0 cellspacing=2
			...
			<tr>
				<td bgcolor="#7892c2"><span class="label-primary">Kullanıcı
						İsmi </span></td>
				<td>:</td>
				<td><input name="Isim" class="form-control" type="text"
					tabindex="1"></input></td>
			</tr>
			<tr>
				<td><span>Şifre </span></td>
				<td>:</td>
				<td><input name="sifre" type="password" tabindex="2"></input></td>
			</tr>



			<tr>
				<td colspan=3 align=center><input type="submit" value="Giriş"
