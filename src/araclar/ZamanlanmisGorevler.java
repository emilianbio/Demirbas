...
public class ZamanlanmisGorevler {
	...
	// "Saniye Dakika Saat Gün Ay(1-31) haftaninGünü(MON-FRI)"
	// @Scheduled(fixedDelay = 5000) //Görev Bittikten 5 saniye sonra yeni görev
	// @Scheduled(fixedRate = 5000) //Görev başladıktan 5 saniye sonra yeni
	// görev
	public void zamanla() throws IOException {
		try {
			URL myURL = new URL(
					"http://localhost:9086/murakib/buguneokumalariekle");
